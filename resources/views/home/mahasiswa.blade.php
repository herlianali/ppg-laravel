                        ...
                        <div class="list-group-item px-0">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="flex-grow-1">
                                    ...
                                    <small class="text-muted">
                                        Status: 
                                        <span class="badge bg-{{ $pengajuan->status == 'diverifikasi' ? 'success' : ($pengajuan->status == 'ditolak' ? 'danger' : 'warning') }}">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('lapor.my.show', $pengajuan->id) }}">
                                                <i class="fas fa-eye me-2"></i>Lihat Detail
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="{{ route('lapor.edit', $pengajuan->id) }}">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('lapor.my.index') }}" class="btn btn-outline-primary">
                            <i class="fas fa-list me-2"></i>Lihat Data Saya
                        </a>
                        <a href="{{ route('ppl.index') }}" class="btn btn-outline-success">
