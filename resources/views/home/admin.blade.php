            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title d-flex align-items-start justify-content-between">
                        ...
                        <span class="badge bg-danger rounded-pill">{{ $statistikVerifikasi['ditolak'] + $statistikVerifikasi['revisi'] }}</span>
                    </div>
                    <span class="fw-semibold d-block mb-1">Perlu Tindakan</span>
                    <h3 class="card-title text-danger mb-2">{{ $statistikVerifikasi['ditolak'] + $statistikVerifikasi['revisi'] }}</h3>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 col-6 mb-3">
                            <a href="{{ route('datamhs.index') }}" class="btn btn-outline-primary w-100">
                                <i class="fas fa-database me-2"></i>
                                Data Mahasiswa
                            </a>
                        </div>
                        <div class="col-md-3 col-6 mb-3">
                            <a href="{{ route('masterdata.index') }}" class="btn btn-outline-success w-100">
                                <i class="fas fa-server me-2"></i>
                                Data Master
                            </a>
                        </div>
                        <div class="col-md-3 col-6 mb-3">
                            <a href="{{ route('setting.index') }}" class="btn btn-outline-info w-100">
                                <i class="fas fa-gears me-2"></i>
                                Pengaturan
                            </a>
                        </div>
                        <div class="col-md-3 col-6 mb-3">
                            <a href="{{ route('lapor.admin.index') }}" class="btn btn-outline-warning w-100">
